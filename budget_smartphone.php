        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand" href="index.php #page-top">
                    <img src="images/logos/logophone.jpg" width="50" height="30" style="margin-top: -5px;" alt="logophone">
                </a>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="section-title">
                        ...
                        <hr>
                        <h3>Berdasarkan pilihan yang anda pilih, anda mengharapkan sebuah smartphone dengan harga terjangkau. Berikut kami sarankan beberapa smartphone yang sesuai dengan kebutuhan anda :</h3>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                            <div class="image-container" style="position: relative; overflow: hidden;">
                                <img src="images/smartphone/phone4.jpg" class="img-fluid" alt="phone4" style="width: 100%; height: auto;">
                                <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                    <div class="overlay-text">
                                        <p style="margin: 0; font-size: 18px; font-weight: bold;">Oppo A58</p>
                                        <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp2.00.000 </h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                            <div class="image-container" style="position: relative; overflow: hidden;">
                                <img src="images/smartphone/phone5.jpg" class="img-fluid" alt="phone5" style="width: 100%; height: auto;">
                                <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                    <div class="overlay-text">
                                        <p style="margin: 0; font-size: 18px; font-weight: bold;">Infinix Note 7</p>
                                        <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp2.100.000 </h3>
                                        <ul style="list-style: none; padding: 0; margin: 0;">
                                            <li>RAM: 6GB</li>
                                            <li>Storage: 128GB</li>
                                            <li>Camera: 48MP</li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                            <div class="image-container" style="position: relative; overflow: hidden;">
                                <img src="images/smartphone/phone6.jpg" class="img-fluid" alt="phone6" style="width: 100%; height: auto;">
                                <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                    <div class="overlay-text">
                                        <p style="margin: 0; font-size: 18px; font-weight: bold;">Realme C53</p>
                                        <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp1.999.000 </h3>
                                        <ul style="list-style: none; padding: 0; margin: 0;">
                                            <li>RAM: 6GB</li>
                                            <li>Storage: 128GB</li>
                                            <li>Camera: 50MP</li>
                        ...
                        <div class="gadget-description">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                <p>Budget smartphone adalah perangkat seluler yang dirancang untuk menawarkan fungsionalitas dasar dan beberapa fitur modern dengan harga yang terjangkau. Smartphone ini ditujukan untuk pengguna yang memiliki anggaran terbatas atau yang tidak memerlukan spesifikasi dan teknologi canggih yang biasanya ditemukan pada perangkat high-end. Berikut adalah beberapa karakteristik utama dari budget smartphone:</p>
                                <li>
                                    <ol>1. Harga Terjangkau: Budget smartphone biasanya dibanderol dengan harga yang lebih rendah dibandingkan dengan smartphone mid-range atau high-end. Kisaran harganya sering berada di bawah $200 atau setara dalam mata uang lokal.</ol>
                                    <ol>2. Spesifikasi Memadai: Meskipun tidak setinggi perangkat kelas atas, spesifikasi pada budget smartphone cukup untuk memenuhi kebutuhan dasar seperti browsing internet, media sosial, dan aplikasi perpesanan. Prosesornya biasanya dari kelas entry-level, seperti seri Snapdragon 400 atau MediaTek Helio seri A.</ol>
                                    <ol>3. Layar yang Layak: Budget smartphone umumnya memiliki layar dengan resolusi HD atau HD+. Ukurannya bervariasi, tetapi biasanya berkisar antara 5 hingga 6,5 inci. Teknologi layar yang digunakan bisa berupa LCD yang menawarkan kualitas tampilan yang cukup baik.</ol>
                                    <ol>4. Kapasitas RAM dan Penyimpanan: Kapasitas RAM pada budget smartphone biasanya antara 2GB hingga 4GB, dengan penyimpanan internal mulai dari 16GB hingga 64GB. Beberapa model juga mendukung kartu microSD untuk ekspansi penyimpanan.</ol>
                                    <ol>5. Kualitas Kamera: Kamera pada budget smartphone umumnya tidak setinggi perangkat high-end, tetapi tetap mampu menghasilkan foto yang baik dalam kondisi pencahayaan yang cukup. Biasanya memiliki kamera utama dengan resolusi antara 8MP hingga 13MP, dan kamera depan sekitar 5MP hingga 8MP.</ol>
                                </li>
                                </div>
                            </div>
                        </div><!-- /.container -->
