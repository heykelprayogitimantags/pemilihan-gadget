            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="section-title">
                        ...
                        <hr>
                        <h3>Berdasarkan pilihan yang anda pilih, anda menginginkan smartphone dengan kemampuan mengelola banyak aplikasi. Berikut kami sarankan beberapa smartphone sesuai kebutuhan anda :</h3>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="image-container" style="position: relative; overflow: hidden;">
                            <img src="images/smartphone/phone11.jpg" class="img-fluid" alt="phone11" style="width: 100%; height: auto;">
                            <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                <div class="overlay-text">
                                    <p style="margin: 0; font-size: 18px; font-weight: bold;">Honor Magic 4</p>
                                    <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp 9.500.000</h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="image-container" style="position: relative; overflow: hidden;">
                            <img src="images/smartphone/phone12.jpg" class="img-fluid" alt="phone12" style="width: 100%; height: auto;">
                            <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                <div class="overlay-text">
                                    <p style="margin: 0; font-size: 18px; font-weight: bold;">Xiaomi M1 12</p>
                                    <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp 4.724.000</h3>
                                    <ul style="list-style: none; padding: 0; margin: 0;">
                                        <li>RAM: 8GB</li>
                                        <li>Storage: 256GB</li>
                                        <li>Camera: 50MP</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="image-container" style="position: relative; overflow: hidden;">
                            <img src="images/smartphone/phone13.jpg" class="img-fluid" alt="phone13" style="width: 100%; height: auto;">
                            <div class="overlay" style="position: absolute; bottom: 0; background: rgba(0, 0, 0, 0.7); color: #fff; width: 100%; padding: 10px;">
                                <div class="overlay-text">
                                    <p style="margin: 0; font-size: 18px; font-weight: bold;">One Plus 9 Pro</p>
                                    <h3 style="margin: 5px 0 10px; font-size: 16px;">Price: Rp5.000.000</h3>
                                    <ul style="list-style: none; padding: 0; margin: 0;">
                                        <li>RAM: 12GB</li>
                                        <li>Storage: 256GB</li>
                                        <li>Camera: 50MP</li>
                    ...
                    <div class="gadget-description">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <p>Multimedia phone adalah jenis smartphone yang dirancang khusus untuk memberikan pengalaman hiburan yang kaya dan berkualitas tinggi. Perangkat ini menawarkan fitur dan spesifikasi unggulan yang memungkinkan pengguna menikmati berbagai bentuk konten multimedia seperti video, musik, game, dan fotografi dengan kualitas yang superior. Berikut adalah beberapa karakteristik utama dari multimedia phone:</p>
                                <li>
                                    <ol>1. Layar Berkualitas Tinggi: Multimedia phone dilengkapi dengan layar besar dan resolusi tinggi (Full HD hingga 4K). Teknologi layar seperti AMOLED atau OLED sering digunakan untuk memberikan warna yang cerah, kontras yang tajam, dan sudut pandang yang luas. Refresh rate tinggi (90Hz, 120Hz, atau lebih) juga menjadi fitur umum untuk pengalaman visual yang lebih halus, terutama saat menonton video atau bermain game.</ol>
                                    <ol>2. Sistem Audio yang Canggih: Smartphone ini biasanya dilengkapi dengan speaker stereo yang menghadap ke depan atau pengaturan speaker ganda untuk menghasilkan suara yang lebih kaya dan imersif. Beberapa model juga mendukung teknologi audio canggih seperti Dolby Atmos untuk pengalaman suara surround yang lebih baik. Dukungan untuk headphone berkualitas tinggi dengan jack audio 3.5mm atau teknologi audio nirkabel juga sering ditemukan.</ol>
                                    <ol>3. Prosesor dan GPU yang Kuat: Untuk mendukung kinerja multimedia yang intensif, multimedia phone dilengkapi dengan prosesor kelas atas dan GPU yang kuat. Chipset seperti Qualcomm Snapdragon seri 8xx atau Apple A-series memastikan bahwa perangkat dapat menjalankan aplikasi dan game berat dengan lancar tanpa lag.</ol>
                                    <ol>4. Kapasitas Penyimpanan yang Besar: Mengingat ukuran file multimedia yang besar, multimedia phone menawarkan kapasitas penyimpanan internal yang besar (128GB, 256GB, atau lebih), serta dukungan untuk kartu microSD pada beberapa model. Ini memungkinkan pengguna menyimpan banyak video, musik, foto, dan aplikasi tanpa khawatir kehabisan ruang.</ol>
                                    <ol>5. Kamera Berkualitas Tinggi: Multimedia phone dilengkapi dengan sistem kamera yang sangat baik untuk fotografi dan videografi. Kamera utama biasanya memiliki resolusi tinggi (48MP, 64MP, atau lebih) dengan berbagai fitur seperti stabilisasi optik, mode malam, dan kemampuan merekam video 4K atau 8K. Kamera depan untuk selfie juga menawarkan resolusi tinggi dan fitur tambahan seperti mode potret dan kecantikan.</ol>
                                </li>
                            </div>
                        </div>
                    </div><!-- /.container -->
