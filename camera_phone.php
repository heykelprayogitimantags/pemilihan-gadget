            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="section-title">
                        ...
                        <hr>
                        <h3>Berdasarkan pilihan yang anda pilih, anda menginginkan sebuah smartphone dengnan kamera yang bagus. Berikut kami sarankan beberapa smartphone sesuai dengan kebutuhan anda :</h3>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="gadget-description">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <p>Camera phone adalah jenis smartphone yang dirancang dengan fokus khusus pada kemampuan fotografi dan videografi. Perangkat ini biasanya dilengkapi dengan teknologi kamera canggih yang memungkinkan pengguna untuk mengambil gambar dan merekam video dengan kualitas tinggi, mendekati atau bahkan setara dengan kamera digital profesional. Berikut adalah beberapa karakteristik utama dari camera phone:</p>
                                <li>
                                    <ol>1. Sistem Kamera Canggih: Camera phone dilengkapi dengan beberapa lensa untuk berbagai kebutuhan fotografi. Ini termasuk lensa utama dengan resolusi tinggi (sering kali 48MP, 64MP, atau bahkan 108MP), lensa ultra-wide untuk menangkap area yang lebih luas, lensa telefoto dengan kemampuan zoom optik, serta lensa makro untuk foto jarak dekat dan depth sensor untuk efek bokeh.</ol>
                                    <ol>2. Sensor dan Optik Berkualitas Tinggi: Sensor pada camera phone biasanya lebih besar dan lebih sensitif terhadap cahaya, yang memungkinkan pengambilan gambar yang lebih baik dalam kondisi pencahayaan rendah. Selain itu, lensa yang digunakan sering kali memiliki aperture yang lebar (seperti f/1.8 atau lebih rendah) untuk memungkinkan lebih banyak cahaya masuk.</ol>
                                    <ol>3. Teknologi AI dan Pemrosesan Gambar: Camera phone dilengkapi dengan kecerdasan buatan (AI) untuk mengoptimalkan setiap bidikan. AI dapat mengenali pemandangan, objek, dan kondisi pencahayaan untuk secara otomatis menyesuaikan pengaturan kamera. Ini termasuk fitur seperti pengenalan wajah, mode malam, HDR (High Dynamic Range), dan stabilisasi gambar.</ol>
                                    <ol>4. Kemampuan Video Tinggi: Selain fotografi, camera phone juga unggul dalam perekaman video. Mereka dapat merekam video dalam resolusi 4K atau bahkan 8K, dengan stabilisasi video yang canggih untuk mengurangi getaran dan guncangan. Beberapa model juga menawarkan fitur perekaman slo-mo (slow motion) dan time-lapse.</ol>
                                    <ol>5. Desain dan Antarmuka Pengguna: Camera phone biasanya memiliki antarmuka pengguna yang dirancang khusus untuk kemudahan penggunaan dalam fotografi. Ini termasuk mode manual atau pro yang memungkinkan pengguna untuk mengatur secara manual pengaturan seperti ISO, kecepatan rana, dan white balance.</ol>
                                </li>
                            </div>
                        </div>
                    </div><!-- /.container -->
